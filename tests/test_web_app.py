...
class WebAppTestCase(unittest.TestCase):
    ...
    def test_report_excel_export_api_returns_workbook(self):
        ...
        self.assertEqual("解説本文", ai_sheet["A9"].value)
        self.assertIn("テスト用のAI解説", str(ai_sheet["A10"].value))
        self.assertEqual("要点一覧", ai_sheet["A12"].value)
    ...
    def test_report_excel_export_api_falls_back_when_ollama_is_unavailable(self):
        ...
        self.assertTrue(str(ai_sheet["A10"].value).strip())
